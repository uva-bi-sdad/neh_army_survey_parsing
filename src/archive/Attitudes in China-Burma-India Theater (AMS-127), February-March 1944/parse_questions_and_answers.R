...
# SET STUDY FOLDER
study_folder <- "data/original/Attitudes in China-Burma-India Theater (AMS-127), February-March 1944"
...
questions <- fix_coded_together(check_instructions(codebook_lines), questions)
